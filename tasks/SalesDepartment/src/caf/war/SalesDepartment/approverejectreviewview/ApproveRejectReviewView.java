...
@ManagedBean(name = "ApproveRejectReviewView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ApproveRejectReviewView", beanType = BeanType.PORTLET)
public class ApproveRejectReviewView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public ApproveRejectReviewView() {
